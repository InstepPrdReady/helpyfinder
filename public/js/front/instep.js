...
( function ( $ ) {
    ...
    $( document ).ready( function () {
		...
		Menu
		==============================*/
		$('.header__btn__instep').on('click', function() {
			$(this).toggleClass('header__btn--active');
			$('.header__menu__instep').toggleClass('header__menu__instep--active');
		});

		$('.header__search__instep .close, .header__action--search button').on('click', function() {
			$('.header__search__instep').toggleClass('header__search--active');
		});


		$(".header__menu__instep .header__nav > li > a").each(function (i){
		...
		if (jQuery('.pace-cover').length) {
			Pace.on('done',function(){window.sr=ScrollReveal();
				...
				sr.reveal('.slider-instep-section .header-social-share',{scale:1,duration:500,delay:500,reset: true});
				...
				sr.reveal('.members-section .instep-team',{scale:1,duration:500,delay:400,reset: true});
    	...
    	$(window).on("load", function() {
		    $('body:not(.rtl) .slider-instep').owlCarousel({
			 	loop: false,
				rewind: true,
				animateIn: 'fadeIn',
				animateOut: 'fadeOut',
	    ...
	    /* HOME SLIDE */
    	$(window).on("load", function() {
		    $('body.rtl .slider-instep').owlCarousel({
			 	loop: false,
				rewind: true,
			 	rtl:true,
			    margin: 10,
    ...
    jQuery(document).on("keyup", function(e) {
      ...
      jQuery(window).on("scroll", function() {
          (jQuery(window).scrollTop() > 250 && jQuery(window).width() > 1200 && (
              ...
              jQuery(".header__content__instep").addClass("animated fadeInDown"
          )),           
          jQuery(window).scrollTop() < 250 && (jQuery("body").removeClass("sticky"), 
          	jQuery(".header-burger .burger").removeClass("animated fadeInDown"),
      	   jQuery(".header__content__instep").removeClass("animated fadeInDown")))
