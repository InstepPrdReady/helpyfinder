...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('instep-backend.section_4_services') , array('Attr.EnableID' => true))}}</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('instep-backend.section_4_services') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th>{{clean( trans('instep-backend.box_icon') , array('Attr.EnableID' => true))}}</th>
                        ...
                        @if($services)
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <p class="mb-0 mt-2"><a href="{{ route('service.edit', $service->id) . '?language=' . request()->input('language') }}">{{clean( trans('instep-backend.edit') , array('Attr.EnableID' => true))}}</a></p>
                                    </td>
