        ...
        <div class="container">
            ...
            <div class="row">
                @foreach($members as $member)
                  <div class="col-md-4">
                      <div class="instep-team">
                          <div class="thumbnail"> 
                              <img width="350" height="350" class="lazy img-fluid" src="/public/img/loading-blog.gif" data-src="{{$member->photo ? '/public/images/media/' . $member->photo->file : '/public/img/200x200.png'}}" alt="team-instep">
                          </div>
                          <div class="content">
