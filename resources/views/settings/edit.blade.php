...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('instep-backend.title_log_favicon') , array('Attr.EnableID' => true))}}</h1>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('instep-backend.title_log_favicon') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
					        ...
					        <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					                    <strong>{{clean( trans('instep-backend.website_title') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <p> <strong>{{clean( trans('instep-backend.logo') , array('Attr.EnableID' => true))}}</strong></p>
                               ...
                               <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.favicon') , array('Attr.EnableID' => true))}} 
                                        
                                        <span>{{clean( trans('instep-backend.upload_image') , array('Attr.EnableID' => true))}} <a target="_blank" href="{{route('media.create')}}"> {{clean( trans('instep-backend.here') , array('Attr.EnableID' => true))}} </a> {{clean( trans('instep-backend.then_copy_url') , array('Attr.EnableID' => true))}} <a target="_blank" href="{{route('media.index')}}"> {{clean( trans('instep-backend.here') , array('Attr.EnableID' => true))}} </a></span>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 maintenance_radio">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.maintenance_status') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="maintenance_status1"> {{clean( trans('instep-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="maintenance_status0"> {{clean( trans('instep-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 maintenance_text @if($setting->maintenance_status == 0) hide @endif">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.maintenance_text') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.loader_status') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="loader_status1"> {{clean( trans('instep-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="loader_status0"> {{clean( trans('instep-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.image_loader') , array('Attr.EnableID' => true))}} 
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.loader_color') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.keywords') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.enable_disable_ogg') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="OGgraph_switch1"> {{clean( trans('instep-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="OGgraph_switch0"> {{clean( trans('instep-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.enable_disable_anali') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="analytics_switch1"> {{clean( trans('instep-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="analytics_switch0"> {{clean( trans('instep-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="pixel_switch1"> {{clean( trans('instep-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="pixel_switch0"> {{clean( trans('instep-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Hubspot For Contact Form</strong>

                                        <div class="form-check">
                                          <input class="form-check-input" type="radio" name="hs_switch" id="hs_switch1" value="1" 
                                            @if($setting->hs_switch == 1) checked @endif>
                                          <label class="form-check-label" for="hs_switch1"> Enable  </label>
                                        </div>
                                        <div class="form-check">
                                          <input class="form-check-input" type="radio" name="hs_switch" id="hs_switch0" value="0" 
                                            @if($setting->hs_switch == 0) checked @endif>
                                          <label class="form-check-label" for="hs_switch0"> Disable  </label>
                                        </div>
                                        <br>

                                        <strong>Region Name</strong>
                                        <input type="text" name="hs_region" value="{{$setting->hs_region}}" class="form-control">
                                        <br>
                                        <strong>Portal Id</strong>
                                        <input type="text" name="hs_portal_id" value="{{$setting->hs_portal_id}}" class="form-control">
                                        <br>
                                        <strong>Form Id</strong>
                                        <input type="text" name="hs_form_id" value="{{$setting->hs_form_id}}" class="form-control">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.enable_disable_schema') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="schema_switch1"> {{clean( trans('instep-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="schema_switch0"> {{clean( trans('instep-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <strong>{{clean( trans('instep-backend.author') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="author" value="{{$setting->author}}" class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <strong>{{clean( trans('instep-backend.contact_address') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="contact" value="{{$setting->contact}}" class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <strong>{{clean( trans('instep-backend.phone') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <strong>{{clean( trans('instep-backend.price_range') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="price_range" value="{{$setting->price_range}}" class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <strong>{{clean( trans('instep-backend.country') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="country" value="{{$setting->country}}" class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <strong>{{clean( trans('instep-backend.address') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.enable_disable_whatsapp') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="enable_disable_whatsapp1"> {{clean( trans('instep-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="enable_disable_whatsapp0"> {{clean( trans('instep-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.google_font') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.custom_css') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('instep-backend.custom_js') , array('Attr.EnableID' => true))}}</strong>
