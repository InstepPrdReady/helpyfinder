...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('instep-backend.create_article') , array('Attr.EnableID' => true))}}</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('instep-backend.create_article') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
                        ...
                        <form action="{{route('post.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="slug-container"><span>{{URL::to('/')}}/{{clean( trans('instep-backend.post') , array('Attr.EnableID' => true))}}/</span><input type="text" name="slug" class="form-control" placeholder=""></div>
                                            </div>
                                        </div>  
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 text-right">
                                    <button type="submit" class="btn btn-primary">{{clean( trans('instep-backend.create_article') , array('Attr.EnableID' => true))}}</button>
                                </div>
                            </div>
