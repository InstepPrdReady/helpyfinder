...
@section('content')
   ...
   <div class="breadcrumb-area">
   	<div class="container">
   		...
   		<ul class="page-list">
            <li class="item-home"><a class="bread-link" href="{{ route('home') }}" title="Home">{{clean( trans('instep-backend.home') , array('Attr.EnableID' => true))}}</a></li>
            <li class="separator separator-home"></li>
            <li class="item-home"><a class="bread-link" href="{{ route('portfolio') }}" title="Home">{{clean( trans('instep-backend.our_projects') , array('Attr.EnableID' => true))}}</a></li>
            <li class="separator separator-home"></li>
   		...
   		<div class="container">
   			...
   			<div class="row">
					<div class="col-md-8">
				        ...
				        <span class="instep-animate-border"></span>
				        {!!$project->body!!}
					</div>
				    <div class="col-md-4">
				        <h4 class="post-name">{{clean( trans('instep-backend.info') , array('Attr.EnableID' => true))}}</h4>
				        <span class="instep-animate-border"></span>
