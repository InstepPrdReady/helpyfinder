...
<body class="common-front @if($currentLang->rtl == 1) rtl @endif" @if($currentLang->rtl == 1) dir="rtl" @endif>
    ...
    <header class="header">
        ...
        <div class="header__content__instep">
            ...
            <div class="header__actions__instep">
            ...
            <div class="header7 sidebar-content">
                <div class="left-side">
                    ...
                    <div class="left-side-inner">
                        ...
                        <div class="header__menu__instep">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    <a href="{{$headerfooter->typed_buttonlink}}" target="_self" class="btn btn-style1"><span>{{$headerfooter->typed_buttontext}}</span><svg class="contact_us_banner_btn_icon" width="11.4" height="9.2"> <use xlink:href="#arrow"></use></svg></a>
                </div>
            </div>
        </div>
    </div>   
