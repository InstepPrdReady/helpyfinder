                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <a  href="{{ url('auth/facebook') }}" class="btn btn-facebook btn-user btn-block">
                                    <i class="fab fa-facebook-f fa-fw"></i> {{clean( trans('instep-backend.register_facebook') , array('Attr.EnableID' => true))}}
                                </a>
                            </form>
                            <hr>
                            <div class="text-center">
                            ...
                            <div class="text-center">
                                <a class="small" href="{{ route('login') }}">{{clean( trans('instep-backend.already_acc') , array('Attr.EnableID' => true))}}</a>
                            </div>
