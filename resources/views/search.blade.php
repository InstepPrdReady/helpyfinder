...
@section('content')
   ...
   <div class="breadcrumb-area">
       <h1 class="breadcrumb-title">{{clean( trans('instep-backend.you_searched_for') , array('Attr.EnableID' => true))}} {{$term}}</h1>
   </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                  <div class="projects projects-page row">
	                ...
	                @else 
					    <div>
					        <h4 class="no-results">{{clean( trans('instep-backend.no_results') , array('Attr.EnableID' => true))}}</h4>
					    </div>
					@endif     
